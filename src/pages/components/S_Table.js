                ...
                <tr {...row.getRowProps()}>
                  {row.cells.map((cell) => (
                    <td className="py-2 whitespace-nowrap">
                      <div className="overflow-x-auto max-w-[97.9px]">
                  ...
                  <td>
                    <button 
                    className="px-1 text-red-500 hover:text-red-700 hover:bg-red-400 hover:rounded-md hover:text-white"
                    onClick={() => onDelete(row.original.id)}>삭제</button>
                  </td>
                </tr>
              );
            })}
